            ...
            <Container className="custom">
                <Row>
                    ...
                    <Col sm="6" className={`${style.gg_map} full767`}>
                        ...
                        <iframe width="600" height="450" style={{border:0}} loading="lazy" allowFullScreen src="https://www.google.com/maps/embed/v1/place?q=5597+Tulip+street+Philadelphia,+Pennsylvania,+Hoa+Kỳ+19124&key=..."></iframe>
