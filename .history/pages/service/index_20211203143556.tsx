...
export const getServerSideProps: GetSe = async () => {
    console.log(process.env.STORED_ID);
    
    const data = await axios({
        method: 'get',
        url: 'https://store-svc-demo.ezsalon.one/api/v1/anonymous/service-group/getAllDetailOnBooking?storeId=0728d3cc-8bab-11ea-953c-3085a9f0088b',
        headers: {}
    })
    return {
        props: {
