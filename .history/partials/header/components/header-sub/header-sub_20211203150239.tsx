...
const getStaticProps: GetStaticProps = () => {
    const phone = process.env.PHONE_STORE
    const address = process.env.ADDRESS_STORE
  return {
      props:{
          phone: process.env.PHONE_STORE,
          address: process.env.ADDRESS_STORE
      }
  }
}
